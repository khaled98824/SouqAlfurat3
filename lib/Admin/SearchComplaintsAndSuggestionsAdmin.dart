...
class SearchComplaintsAndSuggestionsAdmin extends SearchDelegate<String>{
  String collection ;
  SearchComplaintsAndSuggestionsAdmin({this.collection});
  Future<List<DocumentSnapshot>> _future() async{
    ...
    final List<DocumentSnapshot> snap = querySnapshot.documents.where((DocumentSnapshot documentSnapshot) => documentSnapshot["name"].toString().toLowerCase().contains(query.toLowerCase())||documentSnapshot["kind"].toString().toLowerCase().contains(query.toLowerCase())).toList();
    return snap;
  }
                ...
                if (!snapshot.hasData) {
                  ...
                  return GridView.builder(gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 1,childAspectRatio: swidth*0.0026),
                    itemBuilder: (BuildContext context, int index){
                      return SearchListComplaintsAndSuggestionsAdmin(snapshot.data[index]);
...
String idD;
class SearchListComplaintsAndSuggestionsAdmin extends StatelessWidget{
  final DocumentSnapshot lis;
  SearchListComplaintsAndSuggestionsAdmin(this.lis);
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
                  Text( lis.data['mobile'],textAlign: TextAlign.right,
                    style: TextStyle(
                      fontSize: 16,
                      fontFamily: 'AmiriQuran',
                      height: 1,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
                  Text( lis.data['time'],textAlign: TextAlign.right,
                    style: TextStyle(
                      fontSize: 16,
                      fontFamily: 'AmiriQuran',
                      height: 1,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
                  Text( lis.data['uid'].toString(),textAlign: TextAlign.right,
                    style: TextStyle(
                      fontSize: 16,
                      fontFamily: 'AmiriQuran',
                      height: 1,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
                  Text( lis.data['kind'],textAlign: TextAlign.right,
                    style: TextStyle(
                      fontSize: 16,
                      fontFamily: 'AmiriQuran',
                      height: 1,
              ...
              Center(
                child: InkWell(
                    onTap: (){
                      Firestore.instance
                          .collection('Complaints and Suggestions').document(lis.documentID)
                          .delete()
                          .then((value) {
                        print(
                            'delete done');
